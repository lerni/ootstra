    ...
    function getCMSFields()
    {
        ...
        if ($testimonials_selected->count()) {
            ...
            if ($this->isInDB()) {
                ...
                $gridField = new GridField('TestimonialsSelected', 'Testimonials (gefiltert nach Kategorien)', $testimonials_selected, $TestimonialsSelectedGridFieldConfig);
        ...
        if ($this->isInDB()) {
            ...
            $gridField = new GridField('Testimonialsselected', 'Testimonials (alle)', $testimonials_all, $TestimonialsAllGridFieldConfig);
            $fields->addFieldToTab('Root.Main   ', $gridField);
        } else {
            $fields->addFieldToTab('Root.Main', LiteralField::create('firstsave', '<p style="font-weight:bold; color:#555;">' . _t('SilverStripe\CMS\Controllers\CMSMain.SaveFirst', 'none') . '</p>'));
        }
