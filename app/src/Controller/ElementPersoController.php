    ...
    public function qrvc($ID)
    {
        ...
        if ($perso->exists()) {
            ...
            if (!isset($file)) {
                ...
                // Create generic logo
                // $logo = new Logo(path: rtrim(Director::absoluteBaseURL(), '/') . ModuleResourceLoader::resourceURL('themes/default/dist/images/svg/scanme.svg'), resizeToWidth: 68, resizeToHeight: 68)
                // $logo = new Logo(
                //     path: '_resources/themes/default/dist/images/svg/scanme.svg',
                //     resizeToWidth: 68,
                //     resizeToHeight: 68
                // );
